...
export const FavoritePokemonsList = () => {
  ...
  return (
    <Fragment>
      <Typography className="text-center text-gray-400 mb-10">
        You have
        &nbsp;
        {pokemonList.length}
        &nbsp;
      ...
      </Typography>
      {
        withoutPokemons
          ? (
              <div className="grid gap-10  place-items-center text-center text-gray-400">
                <Typography className="max-w-96">
                  Start exploring Pokémon and click the heart icon to add them to your favorites collection!
                </Typography>
      ...
      <div className="flex h-fit min-h-dvh justify-between gap-8 flex-wrap *:max-w-72 py-20">
        {
