...
export const PokemonCard = ({ pokemon, onFavorite, isFavorite }: PokemonCardProps) => {
  ...
  return (
    <Link
      ...
      className={cn([
        'group w-96 relative bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 rounded-2xl p-5 pt-10 cursor-pointer transition-all duration-300  overflow-hidden',
